/********************************** (C) COPYRIGHT *******************************
* File Name     : SSD1306_FONT.H
* Author        : Paul Raspa (PR77)
* License       : MIT
* Version       : V1.0
* Date          : 2024/12/17
* Description   : SSD1306 Display Font
*******************************************************************************/

#ifndef __CH554_SSD1306_FONT_H__
#define __CH554_SSD1306_FONT_H__

#include <stdint.h>
#include "ch554.h"

#undef OLED_FONT_SUPPORT_LOWER_CASE

#define OLED_FONT_CHAR_COUNT (sizeof(OLED_FONT) / (5 * sizeof(OLED_FONT[0])))
...
#if defined(OLED_FONT_SUPPORT_LOWER_CASE)
    ,
...
#endif // OLED_FONT_SUPPORT_LOWER_CASE
};

#endif // __CH554_SSD1306_FONT_H__